...
export default function CartSidebar({ isOpen, onClose }) {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`fixed top-0 right-0 bottom-0 w-full sm:w-96 bg-white z-50 transform transition-transform duration-300 ease-in-out ${
      ...
      >
        <div className="flex flex-col h-full">
          ...
          <div className="px-4 py-5 border-b border-gray-200 flex items-center justify-between">
            <h2 className="text-lg font-medium text-gray-900">Shopping Cart ({itemCount})</h2>
            <button
              type="button"
